...
annasiriyah = ZoneCommander:new({zone='An Nasiriyah', side=1, level=20, size='bignosam', upgrades=upgrades.airfield2, crates={}, flavorText=flavor.annasiriyah, customSuspendNm = 80}),
	...
	hidden1 = ZoneCommander:new({zone='Hidden1', side=0, level=25, upgrades=upgrades.hidden1Group, crates={}, flavorText=flavor.hidden1}),
...
zones.hatay:addGroups({
	...
	GroupCommander:new({name='Hatay-attack-Minakh-Arty', mission='attack',template='ArtilleryConvoyLong',MissionType='ARTY',Reward=250, targetzone='Minakh', type='surface',artilleryRangeNm= 7,SetActiveMission = true}),
...
evc:addEvent({
	...
	action = function()
		...
		RespawnGroup(name)
		RegisterGroupTarget(target[name], 2500, 'Strike mission','Convoyintercept',true)
	end,
	canExecute = function()
...
evc:addEvent({
	...
	action = function()
		...
		RegisterScoreTarget('EnemyHideout',tgt,500,'Strike mission',true)
...
evc:addEvent({
	...
	action = function()
		...
		RegisterScoreTarget('TaftanazWarehouse',tgt,500,'Strike mission', true)
	local p = tgt:GetDCSObject() and tgt:GetDCSObject():getPoint()
		if p then
			missionMarkId = missionMarkId + 1
...
evc:addEvent({
	...
	action = function()
		...
		RegisterScoreTarget('SA11WareHouse',tgt,500,'Strike mission',true)
	local p = tgt:GetDCSObject() and tgt:GetDCSObject():getPoint()
		if p then
			missionMarkId = missionMarkId + 1
			trigger.action.markToCoalition(missionMarkId,'Strike on Abu al-Duhur Papa supply warehouse',p,2,false,false)
...
mc:trackMission({
	title = "Strike on Abu al-Duhurs Papa supply warehouse",
	description =
...
Elevation 1020 feet]],
	messageStart = "New strike mission: Strike on Abu al-Duhurs Papa supply warehouse",
	messageEnd = "Strike mission ended: Strike on Abu al-Duhurs Papa supply warehouse",
    startAction = function()
         if not missionCompleted and trigger.misc.getUserFlag(180) == 0 then
            trigger.action.outSoundForCoalition(2, "ding.ogg")
        end
...
evc:addEvent({
	...
	action = function()
		...
		RegisterScoreTarget('IncirlikWarehouse',tgt,500,'Strike mission',true)
	local p = tgt:GetDCSObject() and tgt:GetDCSObject():getPoint()
		if p then
			missionMarkId = missionMarkId + 1
...
evc:addEvent({
	...
	action = function()
		...
		RegisterScoreTarget('SA5Warehouse',tgt,500,'Strike mission',true)
	local p = tgt:GetDCSObject() and tgt:GetDCSObject():getPoint()
		if p then
			missionMarkId = missionMarkId + 1
...
evc:addEvent({
	...
	action = function()
		...
		if not tgt then
			trigger.action.outText('DavidWarehouse is missing',30)
			return
		end
		RegisterScoreTarget('DavidWarehouse',tgt,500,'Strike mission',true)
	local p = tgt:GetDCSObject() and tgt:GetDCSObject():getPoint()
		if p then
			missionMarkId = missionMarkId + 1
			trigger.action.markToCoalition(missionMarkId,"Strike on Ramat David supply warehouse",p,2,false,false)
...
mc:trackMission({
	title = "Strike on Ramat David supply warehouse",
	description =
[[Ramat David supply warehouse has been found,
Take it out to halt the supplies going to Ramat David Defence from there.
...
Elevation 151 feet]],
	messageStart = "New strike mission: Strike on Ramat David supply warehouse",
	messageEnd = "Strike mission ended: Strike on Ramat David supply warehouse",
    startAction = function()
         if not missionCompleted and trigger.misc.getUserFlag(180) == 0 then
            trigger.action.outSoundForCoalition(2, "ding.ogg")
        end
...
evc:addEvent({
	...
	action = function()
		...
		if not tgt then
			trigger.action.outText('AssadWarehouse is missing',30)
			return
		end
		RegisterScoreTarget('AssadWarehouse',tgt,500,'Strike mission',true)
	local p = tgt:GetDCSObject() and tgt:GetDCSObject():getPoint()
		if p then
			missionMarkId = missionMarkId + 1
			trigger.action.markToCoalition(missionMarkId,"Strike on Bassel Al-Assad supply warehouse",p,2,false,false)
...
mc:trackMission({
	title = "Strike on Bassel Al-Assad supply warehouse for Hotel",
	description =
[[Bassel Al-Assad supply warehouse has been found,
Take it out to halt the supplies going to Hotel from there.
...
Elevation 92 feet]],
	messageStart = "New strike mission: Strike on Bassel Al-Assad supply warehouse for Hotel",
	messageEnd = "Strike mission ended: Strike on Bassel Al-Assad supply warehouse for Hotel",
    startAction = function()
         if not missionCompleted and trigger.misc.getUserFlag(180) == 0 then
            trigger.action.outSoundForCoalition(2, "ding.ogg")
        end
...
evc:addEvent({
	...
	RegisterGroupTarget('StrikeTargetGroup',250,'Strike mission','StrikeTarget',true)
	end,
	canExecute = function()
...
evc:addEvent({
	...
	RegisterGroupTarget('StrikeTargetGroup1',250,'Strike mission','StrikeTarget1',true)
	end,
	canExecute = function()
...
evc:addEvent({
	...
	action = function()
		...
		RegisterGroupTarget('StrikeTargetGroup2',750,'Strike mission','StrikeTarget2',true)
	end,
	canExecute = function()
...
evc:addEvent({
	id='EWRSouth',
	action = function()
		RegisterGroupTarget('Red EWR-south Fixed',1000,'Strike mission','EWRSouth',true)
	end,
	canExecute = function()
...
evc:addEvent({
	id='EWRSA5',
	action = function()
		RegisterGroupTarget('Red EWR-southeast Fixed',1000,'Strike mission','EWRSA5',true)
	end,
	canExecute = function()
