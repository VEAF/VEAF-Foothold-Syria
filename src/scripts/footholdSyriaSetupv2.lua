...
upgrades = {
	...
	HotelFixed = {
		blue = {'bluePD2', 'blueHAWK', 'bluePD1'},
		red = {'Red SAM SHORAD SA-19','Red SAM AAA Fixed Hotel', 'Red SAM SA-2', 'Red SAM SHORAD SA-15', 'Red SAM SHORAD SA-19'}
	},
	sa5 = {
		blue = {'bluePD2', 'bluePD1'},
		red = {'Red Armour Group','Red SAM AAA','Red SAM SHORAD SA-15','Red Armour Group 2','Red SAM SHORAD Tor M2',{ n = "Red SAM SA-5", p = true }}
	},
	insAirfield = {
		blue = {'blueInfantry','bluePD2', 'bluePD1'},
	...
	insGenericFoxtrotFixed = {
		blue = {'blueInfantry','bluePD2', 'blueArmor'},
		red = {'Red SAM AAA Fixed Foxtrot','Enemy ground forces','Red Armour Group','Enemy ground forces','Red SAM AAA 2','Red SAM SHORAD SA-8'}
	},
	insMaximum = {
		blue = {'blueInfantry'},
	...
	bengurionDefence = {
		blue = {},
		red = {'Red SAM SHORAD SA-15',{ n = "Red SAM SA-10", p = true }, 'Red SAM SHORAD SA-19'}
	},
	SilkDefence = {
		blue = {},
		red = {'Silmworm Fixed 1','Red SAM AAA Silk Fixed','Red SAM SHORAD SA-15'}
	},
	ramatdavidDefence = {
		blue = {},
	...
	EwrHiddenNetwork = {
		blue = {},
		red = {'Red EWR north Fixed', 'Red EWR Cyprus Fixed', 'Red EWR-southeast Fixed', 'Red EWR-south Fixed', 'HQ Fixed', 'Red EWR Fixed', 'Red EWR Fixed 2',
		'Red SAM SHORAD SA-15', 'Red SAM SHORAD SA-15'}
	},
	hidden2Group = {
		blue = {},
...
local cwSwap = {
	...
	['Red EWR north Fixed']								= 'Red EWR north Fixed Coldwar',
	['Red EWR Cyprus Fixed']							= 'Red EWR Cyprus Fixed Coldwar',
	['Red EWR-southeast Fixed']						= 'Red EWR-southeast Fixed Coldwar',
	['Red EWR-south Fixed']							= 'Red EWR-south Fixed Coldwar',
...
local vnSwap = {
	...
	['Red Armor Group8'] = 'Red Armor Group Vietnam 3',
...
RandomUpgradeTemplates = {
	small = { sam = 0, shorad = {0,2}, aaa = {0,2}, ground = {0,2}, armor = {0,2}, arty = {0,1}, total = {3,4}, flakChance = 10, flakSecondChance = 0, flakMax = 1, RandomRedPickKeepChance = { ["Red SAM SHORAD Pantsir S1"] = 20, ["Red SAM SHORAD Tor M2"] = 20 } },
	smallmedium = { sam = 0, shorad = {0,3}, aaa = {0,2}, ground = {0,2}, armor = {0,3}, arty = {0,1}, total = {3,5}, flakChance = 12, flakSecondChance = 0, flakMax = 1, RandomRedPickKeepChance = { ["Red SAM SHORAD Pantsir S1"] = 30, ["Red SAM SHORAD Tor M2"] = 30 } },
	medium = { sam = {0,1}, shorad = {0,3}, aaa = {0,3}, ground = {0,2}, armor = {0,3}, arty = {0,2}, total = {3,6}, flakChance = 15, flakSecondChance = 0, flakMax = 1, RandomRedPickKeepChance = { ["Red SAM SHORAD Pantsir S1"] = 40, ["Red SAM SHORAD Tor M2"] = 40 } },
	mediumbig = { sam = {0,1}, shorad = {0,4}, aaa = {0,3}, ground = {0,2}, armor = {0,4}, arty = {0,2}, total = {4,7}, flakChance = 30, flakSecondChance = 5, flakMax = 2, RandomRedPickKeepChance = { ["Red SAM SHORAD Pantsir S1"] = 50, ["Red SAM SHORAD Tor M2"] = 50 } },
	big = { sam = {0,1}, shorad = {0,4}, aaa = {0,3}, ground = {0,2}, armor = {0,4}, arty = {0,2}, total = {4,8}, flakChance = 35, flakSecondChance = 8, flakMax = 2, RandomRedPickKeepChance = { ["Red SAM SHORAD Pantsir S1"] = 70, ["Red SAM SHORAD Tor M2"] = 70 } },
	bignosam = { sam = 0, shorad = {0,4}, aaa = {0,3}, ground = {0,2}, armor = {0,4}, arty = {0,2}, total = {4,8}, flakChance = 35, flakSecondChance = 8, flakMax = 2, RandomRedPickKeepChance = { ["Red SAM SHORAD Pantsir S1"] = 70, ["Red SAM SHORAD Tor M2"] = 70 } },
	extrabig = { sam = {1,2}, shorad = {0,5}, aaa = {0,4}, ground = {0,3}, armor = {0,4}, arty = {0,3}, total = {6,9}, flakChance = 50, flakSecondChance = 20, flakMax = 2, RandomRedPickKeepChance = { ["Red SAM SHORAD Pantsir S1"] = 100, ["Red SAM SHORAD Tor M2"] = 100 } },
	...
	shorad = { sam = 0, shorad = {1,2}, aaa = {1,2}, ground = 0, armor = 0, arty = 0, total = {2,4}, flakChance = 10, flakSecondChance = 0, flakMax = 1, RandomRedPickKeepChance = { ["Red SAM SHORAD Pantsir S1"] = 50, ["Red SAM SHORAD Tor M2"] = 50 } },
	shoradsmall = { sam = 0, shorad = 2, aaa = 0, ground = 0, armor = 0, arty = 0, total = 2, flakChance = 10, flakSecondChance = 0, flakMax = 1, RandomRedPickKeepChance = { ["Red SAM SHORAD Pantsir S1"] = 0, ["Red SAM SHORAD Tor M2"] = 0 } },
	sam2 = { sam = 1, shorad = {1,2}, aaa = {1,2}, ground = 0, armor = {0,1}, arty = 0, total = {3,6}, flakChance = 10, flakSecondChance = 0, flakMax = 1, RandomRedPickKeepChance = { ["Red SAM SHORAD Pantsir S1"] = 50, ["Red SAM SHORAD Tor M2"] = 50 } },
	samspecial = { sam = {2,3}, shorad = {0,4}, aaa = {0,3}, ground = 0, armor = 0, arty = 0, total = {5,8}, flakChance = 25, flakSecondChance = 8, flakMax = 2, RandomRedPickKeepChance = { ["Red SAM SHORAD Pantsir S1"] = 70, ["Red SAM SHORAD Tor M2"] = 70 } },
}
...
FootholdSaveBaseName = (Era == 'Vietnam') and 'footholdSyria_Extended_0.1_vietnam' or ((Era == 'Coldwar') and 'footholdSyria_Extended_0.1_coldwar' or 'footholdSyria_Extended_0.1')
...
-- RemoveSouthSyria support begin
local configuredRemoveSouthSyria = RemoveSouthSyria == true
local configuredStartFromIncirlik = StartNormal == true and StartFromIncirlik == true
local SOUTH_SYRIA_ZONE_NAMES = {
	'Beirut',
	'Rayak',
	'An Nasiriyah',
	'Damascus',
...
local SOUTH_SYRIA_ZONE_SET = {}
for _, zoneName in ipairs(SOUTH_SYRIA_ZONE_NAMES) do
	SOUTH_SYRIA_ZONE_SET[zoneName] = true
end
local SOUTH_SYRIA_UPGRADE_SET = {
	['Red EWR-south Fixed'] = true,
	['Red EWR-south Fixed Coldwar'] = true,
	['HQ Fixed'] = true,
}

local function removeArrayEntries(array, predicate)
	for i = #array, 1, -1 do
...
local function removeSouthSyriaFromTheaterContainers(containers)
	for i = #containers, 1, -1 do
		local container = containers[i]
		if container.zones then
			removeArrayEntries(container.zones, function(member)
				return SOUTH_SYRIA_ZONE_SET[member.name] == true
			end)
			if #container.zones == 0 then
...
local function resolveRemoveSouthSyria()
	if bc.saveLoaded then
		if CustomFlags['RemoveSouthSyria'] == nil then
			CustomFlags['RemoveSouthSyria'] = false
		end
	else
		CustomFlags['RemoveSouthSyria'] = configuredRemoveSouthSyria
	end
	RemoveSouthSyria = CustomFlags['RemoveSouthSyria'] == true
	return RemoveSouthSyria
end

local function applyRemoveSouthSyria()
	if not RemoveSouthSyria then return false end

	local removedZoneObjects = {}
	for _, zoneName in ipairs(SOUTH_SYRIA_ZONE_NAMES) do
		local removedZone = bc:unregisterZone(zoneName)
		if removedZone then
			removedZoneObjects[removedZone] = true
		end
	end
	for zoneKey, zone in pairs(zones) do
		if removedZoneObjects[zone] then
			zones[zoneKey] = nil
		end
	end

	for _, zone in ipairs(bc.zones) do
		for _, upgradeList in pairs({ zone.upgrades and zone.upgrades.red, zone.randomUpgradesRed, zone._configuredStaticUpgrades }) do
			removeArrayEntries(upgradeList, function(entry)
				local entryName = type(entry) == 'table' and (entry.n or entry.name or entry[1]) or entry
				return SOUTH_SYRIA_UPGRADE_SET[entryName] == true
			end)
		end
		removeArrayEntries(zone.groups, function(groupCommander)
			return SOUTH_SYRIA_ZONE_SET[groupCommander.targetzone] == true
		end)
	end

	removeArrayEntries(supplyZones, function(zoneName)
		return SOUTH_SYRIA_ZONE_SET[zoneName] == true
	end)
	for zoneName in pairs(SOUTH_SYRIA_ZONE_SET) do
		supplyZonesSet[zoneName] = nil
	end
	local blueBomberConfig = StrategicBomber.GetConfig(coalition.side.BLUE)
	removeArrayEntries(blueBomberConfig.recoveryZones, function(zoneName)
		return SOUTH_SYRIA_ZONE_SET[zoneName] == true
	end)

	removeArrayEntries(TheaterInfrastructure, function(infrastructure)
		if SOUTH_SYRIA_ZONE_SET[infrastructure.sourceZone] then return true end
		for _, targetZone in ipairs(infrastructure.targetZones or {}) do
			if SOUTH_SYRIA_ZONE_SET[targetZone] then return true end
		end
		return false
	end)

	removeSouthSyriaFromTheaterContainers(TheaterRegions)
	removeSouthSyriaFromTheaterContainers(TheaterAreas)
...
local function anyRegisteredZoneBlue(...)
	for i = 1, select('#', ...) do
		local zone = bc:getZoneByName(select(i, ...))
		if zone and zone.side == coalition.side.BLUE then return true end
	end
	return false
end
-- RemoveSouthSyria support end

zones = {
	akrotiri = ZoneCommander:new({zone='Akrotiri', side=(StartNormal and not configuredStartFromIncirlik) and 2 or 1, size='bignosam', level=20, upgrades=upgrades.airfield, crates={}, flavorText=flavor.akrotiri}),
	...
	incirlik = ZoneCommander:new({zone='Incirlik', side=configuredStartFromIncirlik and 2 or 1, level=20,size='big', upgrades=upgrades.Incirlik, crates={}, flavorText=flavor.incirlik}),
	...
	palmyra = ZoneCommander:new({zone='Palmyra', side=1, level=20,size='extrabig', upgrades=upgrades.airfield2palmyra, crates={}, flavorText=flavor.palmyra, customSuspendNmBlue = 70}),
	...
	sa5 = ZoneCommander:new({zone='SA-5', side=1, level=20,size='sam', upgrades=upgrades.sa5, crates={}, flavorText=flavor.sa5, customSuspendNmRed = 100}),
	...
	carrier = ZoneCommander:new({zone='Carrier Group', side=(StartNormal and not configuredStartFromIncirlik) and 2 or 0, level=20, upgrades=upgrades.carrierFixed, crates={}, flavorText=flavor.carrier}),
	...
	benguriondefence = ZoneCommander:new({zone='Ben Gurion Defence', side=1,size='sam', level=20, upgrades=upgrades.bengurionDefence, crates={}, flavorText=flavor.benguriondefence}),
	...
	silkworm = ZoneCommander:new({zone='Silkworm Site', side=1, size='shorad', level=3, upgrades=upgrades.SilkDefence, crates={}, flavorText=flavor.silkworm}),
	hiddenewr = ZoneCommander:new({zone='HiddenEWR', side=1, size='shoradsmall', level=25, upgrades=upgrades.EwrHiddenNetwork, crates={}, flavorText=flavor.hidden1}),
...
zones.polis:addGroups({
	...
	GroupCommander:new({name='Polis-attack-Paphos', mission='attack', template='AttackConvoy', targetzone='Paphos', type='surface'}),
})
...
zones.pinarbashi:addGroups({
	...
	GroupCommander:new({name='Pinarbashi-attack-Karavostasi-Cas', mission='attack', template='CasHeloTemplate', MissionType='CAS', targetzone='Karavostasi'}),
...
zones.ercan:addGroups({
	...
	GroupCommander:new({name='Ercan-attack-Incirlik', mission='attack', template='CapPlaneTemplate',MissionType='CAP', targetzone='Incirlik', Altitude = CapAltitude(), Bluecondition = function() return zones.redcarrier.side == 2 end}),
	...
	GroupCommander:new({name='Ercan-attack-Pinarbashi', mission='attack', template='AttackConvoy', targetzone='Pinarbashi', type='surface'}),
...
zones.gecitkale:addGroups({
	...
	GroupCommander:new({name='Gecitkale-supply-Incirlik', mission='supply', template='PlaneSupplyTemplate', targetzone='Incirlik',AllowSupplyLaunchFromSuspendedZone = true}),
	...
	GroupCommander:new({name='Gecitkale-attack-Pinarbashi-Cas', mission='attack', template='CasHeloTemplate', MissionType='CAS', targetzone='Pinarbashi'}),
...
zones.larnaca:addGroups({
	...
	GroupCommander:new({name='Larnaca-attack-Paphos-Cas', mission='attack', template='CasPlaneTemplate', MissionType='CAS', targetzone='Paphos', Altitude = CasAltitude()}),
	GroupCommander:new({name='Larnaca-attack-Polis-Cas', mission='attack', template='CasPlaneTemplate', MissionType='CAS', targetzone='Polis', Altitude = CasAltitude()}),
...
zones.durayhim:addGroups({
	GroupCommander:new({name='Durayhim-attack-Duhur-1', mission='attack', template='AttackConvoy', targetzone='Abu al-Duhur', type='surface'}),
	...
	GroupCommander:new({name='Durayhim-attack-Duhur-3', mission='attack', template='AttackConvoy', targetzone='Abu al-Duhur', type='surface'})
})
...
local jirahAttackAleppoSurfaceArty = Era == 'Vietnam' and 'Jirah-attack-Aleppo-surface VT' or 'Jirah-attack-Aleppo-surface'
local jirahAttackDurayhimArty = Era == 'Vietnam' and 'Jirah-attack-Durayhim VT' or 'Jirah-attack-Durayhim'
zones.jirah:addGroups({
	...
	GroupCommander:new({name='Jirah-attack-Hatay-Cap', mission='attack', template='CapPlaneTemplate', MissionType='CAP', targetzone='Hatay', Altitude = CapAltitude()}),
	...
	GroupCommander:new({name='Jirah-attack-Duhur-Cas', mission='attack', template='CasPlaneTemplate', MissionType='CAS', targetzone='Abu al-Duhur', Altitude = CasAltitude()}),
	...
	GroupCommander:new({name=jirahAttackAleppoSurfaceArty, mission='attack', targetzone='Aleppo', type='surface', SetActiveMisison = true}),
	GroupCommander:new({name=jirahAttackDurayhimArty, mission='attack', targetzone='Durayhim', type='surface', SetActiveMisison = true}),
...
zones.tabqa:addGroups({
	...
	GroupCommander:new({name='Tabqa-attack-Foxtrot-Cas', mission='attack', template='CasPlaneTemplate', MissionType='CAS', targetzone='Foxtrot', Altitude = CasAltitude()}),
	...
	GroupCommander:new({name='Tabqa-attack-Taftanaz-Cap', mission='attack', template='CapPlaneTemplate', MissionType='CAP', targetzone='Taftanaz', Altitude = CapAltitude()}),
...
zones.milbase:addGroups({
	...
	GroupCommander:new({name='Milbase-attack-Juliett', mission='attack', template='AttackConvoy', targetzone='Juliett', type='surface'}),
...
zones.alduhur:addGroups({
	GroupCommander:new({name='Alduhur-supply-Aleppo', mission='supply', template='HeloSupplyTemplate', targetzone='Aleppo'}),
	GroupCommander:new({name='Alduhur-supply-Taftanaz', mission='supply', template='HeloSupplyTemplate', targetzone='Taftanaz'}),
	GroupCommander:new({name='Alduhur-supply-Jirah', mission='supply', template='HeloSupplyTemplate', targetzone='Jirah'}),
	GroupCommander:new({name='Alduhur-supply-Hama', mission='supply', template='HeloSupplyTemplate', targetzone='Hama'}),
	GroupCommander:new({name='Alduhur-supply-Al-Assad', mission='supply', template='HeloSupplyTemplate', targetzone='Bassel Al-Assad'}),
	GroupCommander:new({name='Alduhur-supply-India', mission='supply', template='HeloSupplyTemplate', targetzone='India'}),
	GroupCommander:new({name='Alduhur-supply-Factory', mission='supply', template='HeloSupplyTemplate', targetzone='Factory'}),
	GroupCommander:new({name='Alduhur-supply-November', mission='supply', template='HeloSupplyTemplate', targetzone='November'}),
	GroupCommander:new({name='Alduhur-supply-Papa', mission='supply', template='SupplyConvoy', targetzone='Papa', type='surface', condition = function(self) return not (self.side == 1 and CustomFlags["SA11WareHouse"]) end}),
...
zones.alassad:addGroups({
	...
	GroupCommander:new({name='Alassad-attack-Larnaca-Cas', mission='attack', template='CasPlaneTemplate', MissionType='CAS', targetzone='Larnaca', Altitude = CasAltitude(), Redcondition = function() return zones.redcarrier.side ~= 2 end}),
	GroupCommander:new({name='Alassad-attack-Ercan-Cas', mission='attack', template='CasPlaneTemplate', MissionType='CAS', targetzone='Ercan', Altitude = CasAltitude(), Redcondition = function() return zones.redcarrier.side ~= 2 end}),
	GroupCommander:new({name='Alassad-attack-Ercan-RunwayStrike', mission='attack', template='RunwayStrikePlaneTemplate', MissionType='RUNWAYSTRIKE', targetzone='Ercan', Altitude = RunwayStrikeAltitude(), Redcondition = function() return zones.redcarrier.side ~= 2 end}),
...
zones.palmyra:addGroups({
	...
	GroupCommander:new({name='Palmyra-supply-SA5', mission='supply', template='HeloSupplyTemplate', targetzone='SA-5', condition = function(self) if self.side == 1 then return not CustomFlags["SA5Warehouse"] end end}),
	...
	GroupCommander:new({name='Palmyra-patrol-SA5-Cap', mission='patrol', template='CapPlaneTemplate', MissionType='CAP', targetzone='SA-5', Altitude = CapAltitude()}),
	GroupCommander:new({name='Palmyra-patrol-Refinery-Cap', mission='patrol', template='CapPlaneTemplate', MissionType='CAP', targetzone='Refinery', Altitude = CapAltitude()}),
...
zones.dam:addGroups({
	GroupCommander:new({name='Dam-attack-Jirah', mission='attack', template='AttackConvoy', targetzone='Jirah', type='surface'}),
	GroupCommander:new({name='Dam-attack-Foxtrot', mission='attack', template='AttackConvoy', targetzone='Foxtrot', type='surface'})
})
...
zones.shayrat:addGroups({
	...
	GroupCommander:new({name='Shayrat-attack-Hama-Cap', mission='attack', template='CapPlaneTemplate', MissionType='CAP', targetzone='Hama', Altitude = CapAltitude()}),
	...
	GroupCommander:new({name='Shayrat-attack-Palmyra-Cap-2', mission='attack', template='CapPlaneTemplate',MissionType='CAP', targetzone='Palmyra', Altitude = CapAltitude()}),
...
zones.marka:addGroups({
	GroupCommander:new({name='Marka-Supply-King-hussein-air-college', mission='supply', template='HeloSupplyTemplate', targetzone='King Hussein Air College'}),
	...
	GroupCommander:new({name='Marka-patrol-king-hussein-Cap', mission='patrol', template='CapPlaneTemplate', MissionType='CAP', targetzone='Thalah', Altitude = CapAltitude()}),
	GroupCommander:new({name='Marka-attack-king-hussein-Cap', mission='attack', template='CapPlaneTemplate', MissionType='CAP', targetzone='King Hussein Air College', Altitude = CapAltitude()})
})
...
zones.muwaffaq:addGroups({
	...
	GroupCommander:new({name='Muwaffaq-patrol-king-Marka-Cap', mission='patrol', template='CapPlaneTemplate', MissionType='CAP', targetzone='Marka', Altitude = CapAltitude()}),
...
zones.bengurion:addGroups({
	...
	GroupCommander:new({name='Ben-Gurion-supply-Marka-Plane', mission='supply', template='PlaneSupplyTemplate', targetzone='Marka'}),
})
...
local function deployStartFromIncirlikCarrier()
	RespawnGroup("CVN-72")
	RespawnGroup("CVN-74")
	RespawnGroup("Tarawa")
	bc:deployCarrierNavigationArea("CVN72_AREA_RED_CARRIER")
end

function SpawnFriendlyAssets(changedZone)

	if zones.alpha.side == 2 and not zones.alpha.suspended then
	...
	if RemoveSouthSyria then
		if CustomFlags['StartNormalFalse'] == true then
			local reneBlue = bc:getZoneByName("Rene Mouawad").side == coalition.side.BLUE
			local beirutAvailable = not redCarrierBlue
			local reneAvailable = reneBlue and redCarrierBlue
			...
			bc:setCarrierNavigationAreaAvailability({
				CVN72_AREA_BEIRUT = {
					available = beirutAvailable,
					reverse = true,
					autoMove = beirutAvailable,
				},
				CVN72_AREA_RENE = {
					available = reneAvailable,
					reverse = true,
					autoMove = reneAvailable,
				},
				CVN72_AREA_RED_CARRIER = {
					available = redCarrierBlue,
					autoMove = redCarrierBlue,
				},
				CVN72_AREA_RAMAT = false,
				CVN72_AREA_INCIRLIK_SOUTH = false,
			...
			if not bc.carrierNavigation or not next(bc.carrierNavigation) then
				if reneAvailable then
					bc:deployCarrierNavigationArea("CVN72_AREA_RENE")
				elseif beirutAvailable then
					bc:deployCarrierNavigationArea("CVN72_AREA_BEIRUT")
				elseif redCarrierBlue then
					bc:deployCarrierNavigationArea("CVN72_AREA_RED_CARRIER")
				end
			end
		elseif StartFromIncirlik then
			local reneAvailable = bc:getZoneByName("Palmyra").side == coalition.side.BLUE and redCarrierBlue
			bc:setCarrierNavigationAutoRoute({
				"CVN72_AREA_RED_CARRIER",
				"CVN72_AREA_RENE",
			})
			...
			if (not bc.carrierNavigation or not next(bc.carrierNavigation)) and redCarrierBlue then
				deployStartFromIncirlikCarrier()
			end
		else
			local palmyraBlue = bc:getZoneByName("Palmyra").side == coalition.side.BLUE
			bc:setCarrierNavigationAutoRoute({
			...
			bc:setCarrierNavigationAreaAvailability({
				...
				CVN72_AREA_RENE = {
					available = palmyraBlue,
					autoMove = palmyraBlue,
				},
				CVN72_AREA_RED_CARRIER = {
					available = redCarrierBlue,
					via = "CVN72_AREA_TRANSITION",
					viaFrom = "CVN72_AREA_CYPRUS_SOUTH",
					entry = 2,
					autoMove = redCarrierBlue,
				},
	...
	if StartFromIncirlik then
		local reneAvailable = bc:getZoneByName("Palmyra").side == coalition.side.BLUE and redCarrierBlue
		local beirutAvailable = bc:getZoneByName("Beirut").side == coalition.side.BLUE and redCarrierBlue
		local ramatAvailable = bc:getZoneByName("Ramat David").side == coalition.side.BLUE and redCarrierBlue
		bc:setCarrierNavigationAutoRoute({
			"CVN72_AREA_RED_CARRIER",
			"CVN72_AREA_RENE",
			"CVN72_AREA_BEIRUT",
		...
		bc:setCarrierNavigationAreaAvailability({
			...
			CVN72_AREA_RAMAT = {
				available = ramatAvailable,
				autoMove = ramatAvailable,
			},
			CVN72_AREA_INCIRLIK_SOUTH = false,
			CVN72_AREA_CYPRUS_SOUTH = false,
			CVN72_AREA_TRANSITION = false,
...
if Era ~= 'Vietnam' then zones.carrier.isHeloSpawn = true end
...
if Era ~= 'Vietnam' then zones.redcarrier.isHeloSpawn = true end
...
bc:addConnection("Gecitkale","Incirlik")
...
TheaterInfrastructure = {
	{
		id = "incirlik_defence_warehouse",
		flag = "IncirlikWarehouse",
		effect = "defence_supply",
		side = coalition.side.RED,
		scope = "routes",
		sourceZone = "Incirlik",
		targetZones = { "Incirlik Defence" },
	},
	{
		id = "taftanaz_warehouse",
		flag = "TaftanazWarehouse",
	...
	{
		id = "assad_hotel_warehouse",
		flag = "AssadWarehouse",
		effect = "defence_supply",
		side = coalition.side.RED,
		scope = "routes",
		sourceZone = "Bassel Al-Assad",
		targetZones = { "Hotel" },
	},
	{
		id = "palmyra_sa5_warehouse",
		flag = "SA5Warehouse",
		effect = "defence_supply",
		side = coalition.side.RED,
		scope = "routes",
	...
	{
		id = "ramat_david_defence_warehouse",
		flag = "DavidWarehouse",
		effect = "defence_supply",
		side = coalition.side.RED,
		scope = "routes",
		sourceZone = "Ramat David",
		targetZones = { "Ramat David Defence" },
	},
	{
		id = "abu_al_duhur_papa_warehouse",
		flag = "SA11WareHouse",
		effect = "defence_supply",
		side = coalition.side.RED,
		scope = "routes",
		sourceZone = "Abu al-Duhur",
		targetZones = { "Papa" },
	},
}
...
TheaterRegions = {
	{
		...
		name = "Cyprus",
		zones = {
			{ name = "Akrotiri", role = "foothold" },
			{ name = "Paphos", role = "member" },
			{ name = "Polis", role = "member" },
			{ name = "Karavostasi", role = "member" },
			{ name = "Pinarbashi", role = "member" },
			{ name = "Gecitkale", role = "core" },
			{ name = "Ercan", role = "member" },
			{ name = "Larnaca", role = "member" },
			{ name = "Silkworm Site", role = "defence" },
		},
	},
}
...
TheaterAreas = {
	...
	},
	{
		...
		name = "Turkey",
		zones = {
			{ name = "Incirlik", role = "hub", bluePriority = 35 },
			{ name = "Incirlik Defence", role = "defence" },
			{ name = "FOB Alpha", role = "approach" },
			{ name = "Hatay", role = "hub" },
			{ name = "Bravo", role = "support" },
		},
	},
	{
		id = "aleppo",
		kind = "air_network",
		name = "Northwest Syria",
		zones = {
			{ name = "Minakh", role = "gateway" },
			{ name = "Charlie", role = "support" },
			{ name = "Aleppo", role = "hub" },
			{ name = "Taftanaz", role = "hub" },
			{ name = "Delta", role = "approach" },
			{ name = "Power Plant", role = "resource" },
			{ name = "Abu al-Duhur", role = "hub" },
			{ name = "Jirah", role = "hub" },
			{ name = "Durayhim", role = "support" },
			{ name = "Tango", role = "support" },
			{ name = "Substation North", role = "infrastructure" },
			{ name = "Victor", role = "support" },
			{ name = "Papa", role = "defence" },
		},
	},
	{
		id = "euphrates",
		kind = "river_corridor",
		name = "Northeast Syria and Euphrates",
		zones = {
			{ name = "Tabqa", role = "hub" },
			{ name = "Foxtrot", role = "approach" },
			{ name = "Golf", role = "defence" },
			{ name = "Dam", role = "resource" },
			{ name = "Military Base", role = "gateway" },
			{ name = "Oscar", role = "approach" },
			{ name = "Juliett", role = "defence" },
			{ name = "Refinery", role = "resource" },
			{ name = "Sierra", role = "infrastructure" },
			{ name = "TV Tower", role = "infrastructure" },
			{ name = "FOB Mike", role = "support" },
		},
	},
	{
		id = "western_syria",
		...
		name = "Western Syria",
		zones = {
			{ name = "Bassel Al-Assad", role = "hub" },
			{ name = "Hotel", role = "defence" },
			{ name = "Hama", role = "hub" },
			{ name = "India", role = "defence" },
			{ name = "Factory", role = "resource" },
			{ name = "November", role = "gateway" },
			{ name = "Romeo", role = "approach" },
			{ name = "Substation West", role = "infrastructure" },
			{ name = "FOB Lima", role = "support" },
		},
	},
	{
		id = "central_syria",
		kind = "desert_air_network",
		name = "Central Syria",
		zones = {
			{ name = "Palmyra", role = "hub" },
			{ name = "SA-5", role = "defence" },
			{ name = "Tiyas", role = "hub" },
			{ name = "Shayrat", role = "hub" },
			{ name = "Kilo", role = "support" },
			{ name = "Radio Tower", role = "infrastructure" },
			{ name = "Uniform", role = "support" },
		},
	},
	{
		id = "levant_corridor",
		...
		name = "Lebanon",
		zones = {
			{ name = "Rene Mouawad", role = "hub" },
			{ name = "Beirut", role = "hub" },
			{ name = "Rayak", role = "gateway" },
		},
	},
	{
		id = "southern_syria",
		...
		name = "Southern Syria",
		zones = {
			{ name = "An Nasiriyah", role = "hub" },
			{ name = "Damascus", role = "hub" },
			{ name = "Thalah", role = "gateway" },
		},
	},
	{
		id = "israel",
		...
		name = "Israel",
		zones = {
			{ name = "Rosh Pina", role = "gateway" },
			{ name = "Ramat David", role = "hub" },
			{ name = "Ramat David Defence", role = "defence" },
			{ name = "Ben Gurion", role = "hub" },
			{ name = "Ben Gurion Defence", role = "defence" },
		},
	},
	{
		id = "jordan",
		...
		name = "Jordan",
		zones = {
			{ name = "King Hussein Air College", role = "hub" },
			{ name = "Prince Hassan", role = "support" },
			{ name = "Muwaffaq Salti", role = "hub" },
			{ name = "Marka", role = "hub" },
			{ name = "Jordan Defence", role = "defence" },
		},
	},
}
...
resolveRemoveSouthSyria()
applyRemoveSouthSyria()
...
if bc.saveLoaded then
	if CustomFlags['StartFromIncirlik'] == nil then
		CustomFlags['StartFromIncirlik'] = false
	end
else
	CustomFlags['StartFromIncirlik'] = StartNormal and configuredStartFromIncirlik
end
StartFromIncirlik = StartNormal and CustomFlags['StartFromIncirlik'] == true

if not StartNormal then
	for _, upgradeList in pairs({ zones.hiddenewr.upgrades.red, zones.hiddenewr.randomUpgradesRed, zones.hiddenewr._configuredStaticUpgrades }) do
		removeArrayEntries(upgradeList, function(entry)
			local entryName = type(entry) == 'table' and (entry.n or entry.name or entry[1]) or entry
			return SOUTH_SYRIA_UPGRADE_SET[entryName] == true
		end)
...
if not bc.saveLoaded and RemoveSouthSyria and not StartNormal then
	zones.palmyra.side = coalition.side.BLUE
end
...
local disableBlueCarrierAfterInit = not StartNormal or StartFromIncirlik

if RemoveSouthSyria then
	zones.palmyra.LogisticCenter = true
end
...
if not bc.saveLoaded then
    ...
    if not StartNormal then
		...
		if StartFromIncirlik then
			zones.incirlik.LogisticCenter = true
		else
...
bc:init()
if StartFromIncirlik then
	zones.incirlikdefence:disableZone(true)
end
if StartFromIncirlik and (not bc.carrierNavigation or not next(bc.carrierNavigation)) then
	destroyGroupIfActive('CVN-72')
	destroyGroupIfActive('CVN-74')
	destroyGroupIfActive('Tarawa')
end
if not bc.saveLoaded and RemoveSouthSyria and not StartNormal then
	zones.sa5:disableZone(true)
end
if disableBlueCarrierAfterInit then
	...
	if not StartNormal or RemoveSouthSyria then
	...
	if DestroyOnce then
		...
		zones.silkworm:disableZone(true)
		if Era ~= 'Vietnam' and not RemoveSouthSyria then
...
DynamicConvoy.InitTargetTails(16)
...
if Era ~= 'Vietnam' then
	...
	bc:addCarrierNavigationSuspendConnection("CVN72_AREA_RED_CARRIER", "Incirlik",true) -- for Test
...
GlobalSettings.autoSuspendNmBlue = 75   		-- suspend blue zones deeper than this nm
...
local airstrikeGroup = ColdWarTechEra and 'evt-CAScw' or 'evt-CAS'
local activeAirstrikeGroup = nil
...
evc:addEvent({
	...
	action=function()
		...
		airstrikeGroup = ColdWarTechEra and 'evt-CAScw' or (math.random(1, 2) == 1 and 'evt-CAS' or 'evt-CAScw')
		activeAirstrikeGroup = airstrikeGroup
		local spawned = Respawn.SpawnAtPoint(
			activeAirstrikeGroup,
		...
		if not spawned then
			activeAirstrikeGroup = nil
			return
		end
		director:commitTacticalAirstrikeLaunch(selection, airstrike_COOLDOWN)
		RegisterGroupTarget(activeAirstrikeGroup,500,L10N:Get("SYRIA_MISSION_INTERCEPT_AIRSTRIKE_TITLE"),'cas')
		timer.scheduleFunction(function(param)
			if Group.getByName(param.groupName) then
				bc:engageZone(param.targetZone, param.groupName)
			end
		end, {
			groupName = activeAirstrikeGroup,
	...
	canExecute=function()
		...
		if Group.getByName(airstrikeGroup) then return false end
...
mc:trackMission({
	...
	description = function(T)
		...
		local director = Director:getForSide(coalition.side.RED)
		if activeAirstrikeGroup
			and Group.getByName(activeAirstrikeGroup)
	...
	isActive = function()
		...
		if Group.getByName(airstrikeGroup) then return true end
		activeAirstrikeGroup = nil
...
duhurForce = {
	...
	['Hama']            = ColdWarTechEra and { 'evt-hama-duhur-cas-coldwar' }     or { 'evt-hama-duhur-cas' },
	['Bassel Al-Assad'] = ColdWarTechEra and { 'evt-bassel-duhur-sead-Coldwar' } or { 'evt-bassel-duhur-sead' },
}
...
local sceneryList = {
    ...
    ["StrikeKonya1"] = {SCENERY:FindByZoneName("StrikeKonya1")},
    ["StrikeKonya2"] = {SCENERY:FindByZoneName("StrikeKonya2")},
    ["EnemyHideout"] = {SCENERY:FindByZoneName("EnemyHideout")},
    ["ComTower"] = {SCENERY:FindByZoneName("ComTower")},
    ["ComTower2"] = {SCENERY:FindByZoneName("ComTower2")},
...
-------------------------------- Enemy communication tower -------------------------

evc:addEvent({
	id = 'ComTower',
	StrikeMission = true,
	action = function()
		local tgt = sceneryList['ComTower'][1] or SCENERY:FindByZoneName('ComTower')
		if not tgt then
			trigger.action.outText(L10N:Format("SYRIA_SETUP_OBJECT_MISSING", "ComTower"),30)
			return
		end
		RegisterScoreTarget('ComTower',tgt,1000,L10N:Get("SYRIA_MISSION_TARGET_STRIKE_MISSION"),true)
		local p = tgt:GetDCSObject() and tgt:GetDCSObject():getPoint()
		if p then
			missionMarkId = missionMarkId + 1
			trigger.action.markToCoalition(missionMarkId,L10N:Get("SYRIA_MISSION_STRIKE_COM_TOWER_TITLE"),p,2,false,false)
			MissionMarks['ComTower'] = missionMarkId
		end
	end,
	canExecute = function()
	if ActiveMission['ComTower'] then return false end
	if CustomFlags["ComTower"] then return false end
	if bc:getZoneByName('Incirlik').side ~= 2 and bc:getZoneByName('Pinarbashi').side ~= 2 then return false end
	return true
	end,
})

mc:trackMission({
	title = LTGet("SYRIA_MISSION_STRIKE_COM_TOWER_TITLE"),
	description = LTGet("SYRIA_MISSION_STRIKE_COM_TOWER_DESC"),
	messageStart = LTGet("SYRIA_MISSION_STRIKE_COM_TOWER_START"),
	messageEnd = LTGet("SYRIA_MISSION_STRIKE_COM_TOWER_END"),
    startAction = function()
         if not missionCompleted and trigger.misc.getUserFlag(180) == 0 then
            trigger.action.outSoundForCoalition(2, "ding.ogg")
        end
    ...
    endAction = function()
		...
		bc:cancelScoreTargetMission('ComTower')
	end,
	isActive = function()
	if CustomFlags["ComTower"] then return false end
	if ActiveMission['ComTower'] then return true end
	return false
	end
})

-------------------------------- Enemy communications relay ------------------------

evc:addEvent({
	id = 'ComTower2',
	StrikeMission = true,
	action = function()
		local tgt = sceneryList['ComTower2'][1] or SCENERY:FindByZoneName('ComTower2')
		if not tgt then
			trigger.action.outText(L10N:Format("SYRIA_SETUP_OBJECT_MISSING", "ComTower2"),30)
			return
		end
		if isRedTemplateEnabled("SA-2") then
			RespawnGroup('Red SAM SA-2 Fixed ComTower2')
		end
		RegisterScoreTarget('ComTower2',tgt,1000,L10N:Get("SYRIA_MISSION_TARGET_STRIKE_MISSION"),true)
		local p = tgt:GetDCSObject() and tgt:GetDCSObject():getPoint()
		if p then
			missionMarkId = missionMarkId + 1
			trigger.action.markToCoalition(missionMarkId,L10N:Get("SYRIA_MISSION_STRIKE_COM_TOWER_2_TITLE"),p,2,false,false)
			MissionMarks['ComTower2'] = missionMarkId
		end
	end,
	canExecute = function()
	if ActiveMission['ComTower2'] then return false end
	if CustomFlags["ComTower2"] then return false end
...
mc:trackMission({
	title = LTGet("SYRIA_MISSION_STRIKE_COM_TOWER_2_TITLE"),
	description = function(translator)
		local T = translator or L10N
		local description = T:Get("SYRIA_MISSION_STRIKE_COM_TOWER_2_DESC")
		if isRedTemplateEnabled("SA-2") then
			description = description .. "\n\n" .. T:Get("SYRIA_MISSION_STRIKE_COM_TOWER_2_SAM_WARNING")
		end
		return description
	end,
	messageStart = LTGet("SYRIA_MISSION_STRIKE_COM_TOWER_2_START"),
	messageEnd = LTGet("SYRIA_MISSION_STRIKE_COM_TOWER_2_END"),
    startAction = function()
         if not missionCompleted and trigger.misc.getUserFlag(180) == 0 then
            trigger.action.outSoundForCoalition(2, "ding.ogg")
        end
    ...
    endAction = function()
		...
		bc:cancelScoreTargetMission('ComTower2')
	end,
	isActive = function()
	if CustomFlags["ComTower2"] then return false end
	if ActiveMission['ComTower2'] then return true end
	return false
	end
})
...
evc:addEvent({
	...
	if not anyRegisteredZoneBlue('Abu al-Duhur', 'An Nasiriyah', 'Damascus') then return false end
	return true
	end,
})
...
evc:addEvent({
	...
	canExecute = function()
		...
		if not anyRegisteredZoneBlue('Abu al-Duhur', 'Hama', 'An Nasiriyah') then return false end
...
-------------------------------- Deep strike at Konya --------------------------------
local konyaSamType = nil
local konyaSamGroup = nil
if isRedTemplateEnabled("SA-10") then
	konyaSamType = "SA-10"
	konyaSamGroup = 'Red SAM SA-10 Konya Fixed'
elseif isRedTemplateEnabled("SA-2") then
	konyaSamType = "SA-2"
	konyaSamGroup = 'Red SAM SA-2 Konya Fixed'
end

if konyaSamType then
evc:addEvent({
	id = 'StrikeKonya',
	StrikeMission = true,
	action = function()
		local tgt1 = sceneryList['StrikeKonya1'][1] or SCENERY:FindByZoneName('StrikeKonya1')
		local tgt2 = sceneryList['StrikeKonya2'][1] or SCENERY:FindByZoneName('StrikeKonya2')
		if not tgt1 or not tgt2 then
			if not tgt1 then
				trigger.action.outText(L10N:Format("SYRIA_SETUP_OBJECT_MISSING", "StrikeKonya1"),30)
			end
			if not tgt2 then
				trigger.action.outText(L10N:Format("SYRIA_SETUP_OBJECT_MISSING", "StrikeKonya2"),30)
			end
			return
		end

		RespawnGroup(konyaSamGroup)
		RegisterScoreTarget('StrikeKonya',tgt1,2000,L10N:Get("SYRIA_MISSION_TARGET_STRIKE_MISSION"),true)
		RegisterScoreTarget('StrikeKonya',tgt2,2000,L10N:Get("SYRIA_MISSION_TARGET_STRIKE_MISSION"),true)

		local marks = {}
		for _, tgt in ipairs({tgt1, tgt2}) do
			local p = tgt:GetDCSObject() and tgt:GetDCSObject():getPoint()
			if p then
				missionMarkId = missionMarkId + 1
				trigger.action.markToCoalition(missionMarkId,L10N:Get("SYRIA_MISSION_STRIKE_KONYA_TITLE"),p,2,false,false)
				marks[#marks + 1] = missionMarkId
			end
		end
		MissionMarks['StrikeKonya'] = marks
	end,
	canExecute = function()
		if ActiveMission['StrikeKonya'] then return false end
		if CustomFlags["StrikeKonya"] then return false end
...
mc:trackMission({
	title = LTGet("SYRIA_MISSION_STRIKE_KONYA_TITLE"),
	description = function(translator)
		local T = translator or L10N
		return T:Format("SYRIA_MISSION_STRIKE_KONYA_DESC", konyaSamType)
	end,
	messageStart = LTGet("SYRIA_MISSION_STRIKE_KONYA_START"),
	messageEnd = LTGet("SYRIA_MISSION_STRIKE_KONYA_END"),
	startAction = function()
		if not missionCompleted and trigger.misc.getUserFlag(180) == 0 then
			trigger.action.outSoundForCoalition(2, "ding.ogg")
		end
	...
	endAction = function()
		...
		bc:cancelScoreTargetMission('StrikeKonya')
	end,
	isActive = function()
		if CustomFlags["StrikeKonya"] then return false end
		if ActiveMission['StrikeKonya'] then return true end
		return false
	end,
})
end
...
mc:trackMission({
    ...
    isActive = function()
		...
		if Group.getByName(jirahAttackAleppoSurfaceArty) then return true end
		ActiveMission[jirahAttackAleppoSurfaceArty] = nil
		return false
    end
})
...
mc:trackMission({
    ...
    isActive = function()
		...
		if Group.getByName(jirahAttackDurayhimArty) then return true end
		ActiveMission[jirahAttackDurayhimArty] = nil
		return false
    end
})
...
function generateDEADMission()
    ...
    local function isDEADZone(zone)
        local lname = zone.zone:lower()
        return zone.side == 1 and zone.active and not zone.suspended and not bc:isSeadMissionZoneActive(zone.zone) and (lname:find('sam') or lname:find('defence')
...
function RegisterDirectorReconMission(slotIndex)
	...
	messageEnd = function(T)
		...
		if slot.completed and slot.targetZone and slot.winner then
			return Tr:Format("SYRIA_DYNAMIC_RECON_END_BY", slot.targetZone, slot.winner)
		end
		if slot.targetZone then
			return Tr:Format("SYRIA_DYNAMIC_RECON_END_TARGET", slot.targetZone)
		end
